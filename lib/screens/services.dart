...
class ServiceScreen extends StatefulWidget {
  String id;
  String name;
  ServiceScreen({required this.id, required this.name});
  @override
...
class _ServiceScreenState extends State<ServiceScreen> {
  ...
  getData() async {
    Http_Service.getSubcategoryForService(widget.id).then((value) {
      print(value);
      setState(() {
        subcategory = value;
      });
    });
    Http_Service.getWorkWithUsDataGeneral(widget.id).then((data) {
      print(data);
      setState(() {
        workWithUsData = data;
        loading = false;

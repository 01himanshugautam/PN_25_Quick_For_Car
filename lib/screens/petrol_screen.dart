...
class PetrolScreen extends StatefulWidget {
  const PetrolScreen({Key? key}) : super(key: key);

  @override
  _PetrolScreenState createState() => _PetrolScreenState();
}
...
class _PetrolScreenState extends State<PetrolScreen> {
  ...
  getData() {
    Http_Service.getWorkWithUsDataAlignMent().then((data) {
      print(data);
      setState(() {
        workWithUsData = data;
        loading = false;

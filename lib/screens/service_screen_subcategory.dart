...
class ServiceScreen2 extends StatefulWidget {
  int id;
  String name;
  ServiceScreen2({required this.id, required this.name});
  @override
  _ServiceScreenState createState() => _ServiceScreenState();
}

class _ServiceScreenState extends State<ServiceScreen2> {
  ...
  getData() async {
    await Http_Service.getWorkWithUsDataGeneralForSubcategory(widget.id)
        .then((data) {
      print(data);
      setState(() {
        workWithUsData = data;
